            ...
            With G
                ...
                Select Case ToggleType
                    Case _Type.CheckMark
                        If Toggled Then
                            G.DrawString("Ã¼", New Font("Wingdings", 18, FontStyle.Regular), Brushes.WhiteSmoke, Bar.X + 18, Bar.Y + 19, New StringFormat() With {.Alignment = StringAlignment.Center, .LineAlignment = StringAlignment.Center})
                        Else
